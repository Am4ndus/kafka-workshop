...
class PayloadReaderTest {
    ...
    private PayloadReader testSubject;
    @BeforeEach
    void setup() {
        testSubject = new PayloadReader();
    }
    ...
    void shouldParseValidMessage(){
        ...
        String validJsonMessage = getValidJson();

        //when
        //The test subject (reader) reads the message
        Payload payload = testSubject.read(validJsonMessage);
    ...
    @Test
    void shouldThrowForInvalidMessage(){
        //given
        //an invalid JSON message is sent
        String validJsonMessage = "invalid message";
